...
const HeroSection = () => {
  return (
    <div className="h-[95vh]">
      ...
      {/* logo at center */}
      <div className="w-10">
        <div className="animate-rotateRing absolute left-[43%] top-[7rem] h-[12rem] w-[12rem] -translate-x-1/2 transform rounded-full border-[4px] border-solid border-violet-300 border-l-transparent border-r-transparent"></div>
